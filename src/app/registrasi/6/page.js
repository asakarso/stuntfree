    ...
    return (
      <main className="bg-gradient-to-b from-[#2A3C59] to-[#5B81BF] h-screen w-screen flex ">
        ...
        <div className="flex flex-col justify-center items-center text-center margin-0-auto w-screen gap-14">
            ...
            <p className="text-3xl font-bold tracking-wide">Masukkan Berat Badan Lahir Bayi Anda</p>
            <div className="w-[60%]">
                <div className="flex w-full">
                  <input type="number" placeholder="Masukkan berat badan lahir bayi (kg)" className="appearance-none bg-transparent border-none w-full text-white mr-3 pb-3 leading-tight focus:outline-none text-xl"  required></input>
                  <Link href="./7">
